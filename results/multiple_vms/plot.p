...
set output 'replica_scale_compare.eps'
#unset key
...
#set ytics 0,50,450
     set yrange [ 0:40]
      ...
      set ylabel "Throughput(Gbps)" font "Times-Roman,25" offset -0.5,-1,0
        ...
        #set ytics nomirror
      plot "replica_scale.txt" using 1:2  with linespoints ls 1 title 'Throughput' axis x1y1, "replica_scale.txt" using 1:3  with linespoints ls 3 title 'cpu util' axis x1y2, \
      "replica_scale.txt" using 1:4  with linespoints ls 5 title 'Throughput 1024' axis x1y1, "replica_scale.txt" using 1:5  with linespoints ls 3 title 'cpu util 1024' axis x1y2, \
      "replica_scale.txt" using 1:6  with linespoints ls 4 title 'Throughput 64' axis x1y1, "replica_scale.txt" using 1:7  with linespoints ls 3 title 'cpu util 64' axis x1y2
