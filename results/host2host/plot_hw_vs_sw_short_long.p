...
set output 'core_scale_compare_short_long.eps'
#unset key
...
#set ytics 0,50,450
 ...
 #       set y2label "CPU Utilization"
        #set ytics nomirror
      plot "core_scale_host.txt" using 1:2  with linespoints ls 1 title 'H/W distribution: long connection', "core_scale_vm.txt" using 1:2  with linespoints ls 3 title 'S/W distribution: long connection', "64B.txt"  using 1:2  with linespoints ls 2 title 'H/W distribution: short connections', "64B.txt" using 1:4  with linespoints ls 4  title 'S/W distribution: short connection'